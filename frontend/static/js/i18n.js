...
const i18n = {
    zh: {
        ...
        database: {
            ...
            dbName: '数据库名',
            dbNamePlaceholder: '留空使用所有数据库',
            hint: '提示：留空可访问所有可用数据库',
            testConnection: '测试连接',
            saveConfig: '保存配置',
    ...
    en: {
        ...
        database: {
            ...
            dbNamePlaceholder: 'Leave empty to use all databases',
            hint: 'Hint: Leave empty to access all available databases',
